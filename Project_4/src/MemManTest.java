...
public class MemManTest extends TestCase {
    ...
    /**
     * This test uses the input and output from the project spec
     */
    public void testMainFull() {
        String[] arguments = { hashTableSize, memPoolSize, fileName2 };
        PrintStreamWithHistory sysout = systemOut();
        sysout.clearHistory();
        ...
        String output =
            "|When Summer's Through| does not exist in the song database.\r\n"
                ...
                + "(44,11) -> (97,28) -> (239,17)\r\n"
                + "|Blind Lemon Jefferson| duplicates a record already"
